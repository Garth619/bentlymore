...
<div class="lower_footer">
	...
	<div class="lower_footer_inner">
		...
		<div class="copyright_wrapper">
			...
			<span class="copyright">&copy; 2017 Bentley & More LLP. All Rights Reserved.  <a href="">Privacy Policy</a><a href="">Disclaimer</a></span><!-- copyright -->
			
			<a class="ilawyer" href="//ilawyermarketing.com" target="_blank">
				
				<img src="<?php bloginfo('template_directory');?>/images/logo-ft-ilawyer.svg"/>
