...
-------------------------------------------------------------- */
 ...
 function load_my_styles_scripts() {
     // Load my stylesheet
     wp_enqueue_style( 'styles', get_template_directory_uri() . '/style.css', '', 10, 'all' ); 
     ...
     if(is_front_page()) {
	     ...
	     wp_enqueue_script( 'waypoints-homepage', get_template_directory_uri() . '/js/waypoints-homepage-min.js', array('jquery'), '', true );
	     
     }
     
     else {
	     
	     wp_enqueue_script( 'waypoints-internals', get_template_directory_uri() . '/js/waypoints-internals-min.js', array('jquery'), '', true );
...
register_nav_menus(array(
    'main_menu' => 'Main Menu',
    'practicearea_menu' => 'Practice Areas Menu',
